 ...
 */
let employee: [number, string] = [1, "Sabuj"];
...
// This makes the data truly immutable and safe.


// Named Tuples (Best for Team Projects)
// Adding labels makes it clear what the data represents in VS Code tooltips.
type ResponseResult = [statusCode: number, message: string];
const success: ResponseResult = [200, "Success"];
